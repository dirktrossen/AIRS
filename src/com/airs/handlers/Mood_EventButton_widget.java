 ...
 */
public class Mood_EventButton_widget extends AppWidgetProvider
{	
	/**
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) 
    {
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widgetlayout_combined);
        
        // create our own broadcast event for mood button pressing -> MoodButtonHandler subscribes to this!
        ...
        defineIntent = new Intent("com.airs.eventbutton");
        pendingIntent = PendingIntent.getBroadcast(context, 0, defineIntent, PendingIntent.FLAG_UPDATE_CURRENT); 
