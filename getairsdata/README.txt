...
This software is meant to be used together with the files obtained from the AIRS platform (https://github.com/dirktrossen/AIRS).
Its purpose is to parse the AIRS locally recorded data files and save the data in a MySQL database for easier access and further processing.
...
One way of using this software with AIRS is through its 'Sharing' feature. For this, start AIRS and choose in the option menu 'Sync'. This will show a list of your local recordings that have not been synchronised yet with your computer. Select the readings you want and select 'Share', followed by the means of sharing you want (e.g., Bluetooth). 

On the computer, copy the received files to the directory defined in the settings file as AIRS_STORAGE and run this software as instructed above.
 
--------------------------------
System and software requirements
--------------------------------

The software should run on any platform that runs Java. It has been tested with Mac OSX Snow Leopard. 
